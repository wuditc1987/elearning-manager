...
DROP TABLE IF EXISTS `spring`.`sys_config`;
DROP TABLE IF EXISTS `spring`.`sys_depart_role`;
DROP TABLE IF EXISTS `spring`.`sys_department`;
DROP TABLE IF EXISTS `spring`.`sys_dict`;
DROP TABLE IF EXISTS `spring`.`sys_file`;
DROP TABLE IF EXISTS `spring`.`sys_i18n_messgae`;
DROP TABLE IF EXISTS `spring`.`sys_menu`;
DROP TABLE IF EXISTS `spring`.`sys_message`;
DROP TABLE IF EXISTS `spring`.`sys_role`;
DROP TABLE IF EXISTS `spring`.`sys_role_menu`;
DROP TABLE IF EXISTS `spring`.`sys_user`;
DROP TABLE IF EXISTS `spring`.`sys_user_role`;
...
BEGIN;
LOCK TABLES `spring`.`sys_config` WRITE;
DELETE FROM `spring`.`sys_config`;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `spring`.`sys_depart_role` WRITE;
DELETE FROM `spring`.`sys_depart_role`;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `spring`.`sys_department` WRITE;
DELETE FROM `spring`.`sys_department`;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `spring`.`sys_dict` WRITE;
DELETE FROM `spring`.`sys_dict`;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `spring`.`sys_file` WRITE;
DELETE FROM `spring`.`sys_file`;
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `spring`.`sys_i18n_messgae` WRITE;
DELETE FROM `spring`.`sys_i18n_messgae`;
UNLOCK TABLES;
COMMIT;
BEGIN;
...
COMMIT;
BEGIN;
LOCK TABLES `spring`.`sys_message` WRITE;
DELETE FROM `spring`.`sys_message`;
UNLOCK TABLES;
COMMIT;
BEGIN;
